...
UPSTREAM_REPO = "https://github.com/pragy-dl/AnnayanXUserbot"
...
async def update_userbot(client, message):
    ...
    if update_avail:
        ...
        os.system(f"kill -9 {os.getpid()} && python3 -m AnnayanX")
        return
    else:
        await message.edit(f"**🥀 AnnayanX Userbot Already\nUpdated To Latest 🔥 ...\n\n💕 For Any Query › Contact\nTo » @AnnayanX ✨ ...**")

__NAME__ = "Update"
__MENU__ = f"""
**🥀 Use This Plugin To Update
Your AnnayanX Userbot.**
