                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"img url",
                                title="🥀 AnnayanX Userbot ✨",
                                thumb_url=f"img url",
                                description=f"🌷 Deploy Your Own AnnayanXUserbot 🌿...",
                                caption=f"<b>🥀 Welcome › To › AnnayanX 🌷\n✅ Userbot v2.0 ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Deploy Your Own AnnayanX Userbot❗...\n\nRepo:** <i>repo link/</i>||"
                                ),
                            )
                        )
                    ],
